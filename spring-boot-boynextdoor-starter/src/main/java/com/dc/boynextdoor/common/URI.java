...
import com.dc.boynextdoor.utils.NetUtils;
...
public final class URI {
    ...
    public String getServiceName(boolean simple) {
        String xx = getParameter(Constants.INTERFACE_SIMPLE_KEY, path);
        return simple ? xx : getParameter(Constants.INTERFACE_KEY, path);
    }
